...
Der Mittelwert oder auch Durchschnitt der gemessenen Ca-Ionen ist hier 21,926 µmol/g. Der Median, bei dem die Anzahl der Werte halbiert wird, beträgt 19,491 µmol/g.
...
psych::describe(Ca)
```
Die Varianz für die austauschbaren Ca-Ionen ist 123,85 µmol/g. Die Standardabweichung, also die Wurzel aus der Varianz ist 11,13 µmol/g. Das bedeutet..
...
Um einen besseren Überblick über die Verteilung der austauschbaren Ca_Ionen zu erhalten, sollten die zwei höchsten Werte (94,31 µmol/g und 71,7 µmol/g) evtl. aus der Berechnung rausgelassen werden, da dort scheinbar Messfehler vorliegen.
